...
import "./produtos/carro.js";
import "./produtos/alimentacao.js";
import "./produtos/limpeza.js";
...
function aplicaDesconto(){
    valorFinal.textContent = `Valor com Desconto: R$ ${carrinho.calcularValorFinal()}`;
}
